...
It also allows a time limit in seconds to be set using a third command-line
argument.  To use the default value of the l parameter along with a timeout,
use -1 for the second command-line argument.
